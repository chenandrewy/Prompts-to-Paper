...
with open("./latex/full_paper.tex", "r", encoding="utf-8") as f:
    lines = f.readlines()
    start_index = next((i for i, line in enumerate(lines) if line.strip() == r'\documentclass{article}'), None)
    if start_index is not None:
        lines = lines[start_index:]
    end_index = next((i for i, line in enumerate(lines) if line.strip() == r'\end{document}'), None)
