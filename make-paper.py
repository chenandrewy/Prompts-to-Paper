...
At the end of the abstract write "Unlike previous work, all text in this paper is generated by an LLM." Also include a subtle footnote in the introduction noting that "we" in this paper refers to one human author and multiple LLMs.

In the introduction, give as an example the current paper, which is entirely written by AI, using 6 short prompts, and a selection process for selecting the best paper out of 100. Give a link to the github site, which is https://github.com/chenandrewy/Prompts-to-Paper/. 
