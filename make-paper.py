...
Make sure all citations match actual papers in the bibliography documents. Output as a latex document with complete bibliography. Output only the latex code, no other text. The latex code is intended for compiling, assuming that lit-99-bibtex.bib is in the relative path ../input-other/.
